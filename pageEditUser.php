...
<header id="head">
    <nav id="menu">
        <ul>
            ...
            <li onmouseover="chanceImg('_images/img-prod.png')" onmouseout="chanceImg('_images/img-user.png')"><a href="products.php">Produtos</a></li>
        </ul>
    </nav>
...
<section class="container">
    <form method="post" id="formUser" action="editUser.php">
        <fieldset id="fUser">
    ...
    <form>
        <input type="image" name="tBtnRet2" id="cBtnRet2" src="_images/btn-return.png" height="40px" formaction="users.php"/>
    </form>
