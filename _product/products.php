...
<body>
    <header id="head">
        <nav id="menu">
            <ul>
                <li onmouseover="chanceImg('../_images/img-home.jpg')" onmouseout="chanceImg('../_images/img-prod.png')"><a href="../home.php">Home</a> </li>
    ...
    <section class="container">
        <form method="post" id="formProd" action="saveProduct.php">
            <fieldset id="fProd">
